...
export default function ProjectsGallery() {
  ...
  // Moves the track horizontally as user scrolls down
    ...
    >
      ...
      <div className="sticky top-0 h-screen w-full overflow-hidden bg-[#f5f4f0]">
        ...
        <motion.div
          ...
          className="absolute top-10 left-6 md:left-16 right-6 md:right-16 flex justify-between items-center z-20"
        >
        ...
        {/* Big headline — sits top-left, fades as gallery scrolls */}
        <motion.div
          style={{ opacity: headerOpacity, y: headerY }}
          className="absolute top-20 md:top-24 left-6 md:left-16 z-10 pointer-events-none"
        >
          <h2
            className="text-[13vw] md:text-[7vw] font-bold leading-[0.88] tracking-tighter uppercase text-[#111]"
        ...
        <motion.div
          style={{ x }}
          className="absolute top-0 left-0 h-full flex items-center gap-8 md:gap-12"
          // width needs to be explicit so flex doesn't wrap
        >
          {/* Leading spacer — pushes cards to start below/right of headline */}
          <div className="flex-shrink-0 w-[45vw] md:w-[42vw] h-px" />

          {projects.map((project, i) => (
            <motion.div
              key={project.id}
              className="relative flex-shrink-0 w-[70vw] md:w-[36vw] lg:w-[28vw] cursor-pointer group"
            ...
            >
              ...
              <div className="mt-5 flex justify-between items-end">
                <div>
                  <h3
                    className="text-base md:text-lg font-bold uppercase tracking-tight text-[#0a0a0a] mb-1"
                    style={{ fontFamily: "var(--font-display)" }}
                  >
                    {project.title}
                  </h3>
        ...
        <div className="absolute bottom-8 left-6 md:left-16 right-6 md:right-16">
