  ...
  return (
    <section id="projects" className="bg-[#f5f4f0]">
      ...
      <div className="block md:hidden px-6 pt-24 pb-16">
        ...
        <div className="flex flex-col gap-16">
          {PROJECTS.map((project, i) => {
            const isLogo = project.slug === "leadoi";
            return (
              <Link
                key={project.slug}
                ...
                >
                  ...
                  <div className="flex justify-between items-end">
                    <div>
                      ...
                      <p className="mt-1.5 text-[11px] font-light text-black/50 leading-snug">
      ...
      <div className="hidden md:block">
        <div ref={containerRef} className="relative h-[450vh] bg-[#f5f4f0]">
              ...
              {PROJECTS.map((project, i) => {
                ...
                return (
                  <Link
                    key={project.slug}
                    href={`/${language}/work/${project.slug}`}
                    className="relative flex-shrink-0 w-[36vw] lg:w-[28vw] block group"
                  >
                    <motion.div
                      ...
                      <div className="relative w-full aspect-[3/4] overflow-hidden bg-[#e5e3de]">
                        ...
                        >
                          <Image
                            ...
                            className={isLogo ? "object-contain p-16" : "object-cover"}
                            quality={90}
                            loading="lazy"
                          />
                        </motion.div>
